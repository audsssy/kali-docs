...
// Template
const PropertyTokenizer = ({  }) => {
  return (
    <Document>
      <Page style={styles.body}>
      **Severance and Tokenization Agreement of {HEADER}**
...
4. Agree that upon payment of a liquidated amount of {LIQUIDATEDAMOUNT}, the Holder shall grant said Owner the right, but not the obligation, to repurchase Severed Property at any time thereby revoking the License and this Agreement (the &quot;Option&quot;). For avoidance of doubt, Severed Property would resume its state as a fixture and constructively merge and become part of the Real Property upon exercise of this Option.
...
(k) \*\*&quot;Designated Smart Contract&quot;\*\* means the smart contract deployed on {NETWORK} mainnet (networkID:{NETWORKID}, chainID:{CHAINID}) at {DESIGNATEDSMARTCONTRACTADDRESS}.
