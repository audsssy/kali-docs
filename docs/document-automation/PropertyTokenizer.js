...
const PropertyTokenizer = ({ header, effectivedate, owneraddress, holder, holderaddress, propertydesc, licenselang, token, amount, term, licensefee, prohibitions, choiceoflaw, designatedclient, network, networkid, chainid, smartaddress, imagelink   }) => {
  return (
    <Document>
      ...
      <p><strong>THIS SEVERANCE AND TOKENIZATION AGREEMENT OF {header}</strong> (&quot;Agreement&quot;) is made and entered into effective as of {effectivedate} (&quot;Effective Date&quot;), by and between the owner represented at Account Address {owneraddress} (&quot;Owner&quot;) of real, tangible or personal property, and {holder} (&quot;Holder&quot;) represented at Account Address {holderaddress}. Owner and Holder are referred to collectively below as the &quot;Parties.&quot;</p>
<p><strong>WHEREAS</strong> , Owner is the owner of that certain tangible, personal or real property commonly known as the {propertydesc} (&quot;Real Property&quot;); and</p>
<p><strong>WHEREAS</strong> , Holder and Owner desire to constructively sever and treat as personal property (&quot;Severed Property&quot;); and</p>
<p><strong>WHEREAS</strong> , Holder and Owner desires to mint cryptographic tokens to manage and represent certain rights, ownership and control over the Severed Property (&quot;Severed Property Token&quot;); and</p>
<p><strong>WHEREAS</strong> , Holder desires to transfer ownership of the Severed Property Token to the Holder; and</p>
<p><strong>WHEREAS</strong> , Holder desires to obtain license to {licenselang}; and</p>
<p><strong>NOW, THEREFORE</strong> , in consideration of the foregoing recitals, which are hereby incorporated into this Agreement, and other good and valuable consideration, the receipt and sufficiency of which are hereby acknowledged, the Parties hereby:</p>
<ol>
<li>Agree that the Severed Property typically considered a fixture or otherwise real property, is considered severed by this agreement and shall be considered personal property until which time the Option to repurchase is exercised and Severed Property merges back with the Real Property,</li>
<li>Consent that the {token} will be minted and the parties will defer to this agreement to govern and manage the Severed Property using the Severed Property Token,</li>
<li>Consent to the License from the Owner to the Holder to access Severed Property, and</li>
<li>Agree that upon payment of a liquidated amount of {amount}, the Holder shall grant said Owner the right, but not the obligation, to repurchase Severed Property at any time thereby revoking the License and this Agreement (the &quot;Option&quot;). For avoidance of doubt, Severed Property would resume its state as a fixture and constructively merge and become part of the Real Property upon exercise of this Option.</li>
</ol>
<p><strong>Revocable License</strong>
Grant of Revocable License. Subject to the terms of this Agreement, Owner hereby grants to Holder a revocable license for the Term of this Agreement to use that portion of Real Property shown on the Site Plan for the sole use of traversing the Real Property {licenselang} to use, enjoy, or harvest Severed Property. It is specifically determined that Holder may not {prohibitions}. The ownership of Severed Property and license shall be managed and represented amongst the parties through the minting of a token on the Designated Blockchain Network and shall also include a Cryptographic Hash Function to map the executed document using IPFS of this executed Agreement.</p>
<p><strong>Term</strong> 
This License shall be for a term of {term}. This License shall automatically expire at the end of the Term, unless both parties agree otherwise.</p>
<p><strong>License Fee</strong>
The Holder agrees to pay Owner {licensefee} for the Term of the Agreement.</p>
<p><strong>Restrictions</strong>
 Holder is expressly prohibited from changing the Real Property in any manner and shall tread lightly. Holder shall permit no liens to be filed against Real Property and Holder shall indemnify and hold Owner and its successors and assigns harmless from and against all costs or expenses of any kind, including but not limited to attorneys&#39; fees, incurred by Owner or its successors or assigns related to any such lien or any notice of intent to file such a lien. The provisions of this paragraph shall survive the termination of this Agreement.</p>
<p><strong>Insurance</strong>
 Owner shall not provide insurance for Holder and Owner shall not be liable for damages or injuries caused by or arising from actions or nonactions of the Owner. Holder assumes all risk from actions or inactions on the property and agrees that they will obtain insurance showing evidence of liability coverage for bodily injury, death, and property damage to any person.</p>
<p><strong>Termination</strong>
 This Agreement is for the sole benefit of Owner and shall not create any easement or other interest in Real Property in favor of Holder. This Agreement and the license granted herein shall not run with the land. Owner may terminate this agreement and the revocable license at any time upon exercise of the Option. Any attempted alienation or assignment without Owner&#39;s consent as provided herein shall be null and void and without legal effect as it is a NON FUNGIBLE token.</p>
<p><strong>Effect of Termination</strong> 
Upon the termination of this Agreement after Owner excercises the Option or through its natural expiry of the Term the token shall be constructively destroyed (a &quot;Token Burn&quot;), Holder shall no longer have any right to visit the Real Property unless invited.</p>
...
<p><strong>Counterparts; Signatures</strong>
 The parties hereto agree that this Agreement shall be executed via signed transaction on the Designated Blockchain Network through a function call of <code>transfer()</code> to the smart contract initiated transfer of the Token from Owner to Holder, and payment of License Fee from Holder to Owner (the &quot;Signature&quot;).</p>
<p><strong>IN WITNESS WHEREOF</strong> , this Agreement is entered into by the Parties as of the Effective Date upon the effectuated Signature of the parties.</p>
<p>/s Owner</p>
<p>/s Holder</p>
...
<p>(m) **&quot;Legal Order&quot;** means any restraining order, preliminary or permanent injunction, stay or other order, writ, injunction, judgment or decree that either: (i) is issued by a court of competent jurisdiction, or (ii) arises by operation of applicable law as if issued by a court of competent jurisdiction, including, in the case of clause &quot;(ii)&quot; an automatic stay imposed by applicable law upon the filing of a petition for bankruptcy.</p>
<p>(n) **&quot;Legal Proceeding&quot;** means any private or governmental action, suit, litigation, arbitration, claim, proceeding (including any civil, criminal, administrative, investigative or appellate proceeding), hearing, inquiry, audit, examination or investigation commenced, brought, conducted or heard by or before, or otherwise involving, any court or other governmental entity or any arbitrator or arbitration panel.</p>
<p>(o) **&quot;Liability&quot;** means any debt, obligation, duty or liability of any nature (including any unknown, undisclosed, unmatured, unaccrued, unasserted, contingent, indirect, conditional, implied, vicarious, inchoate derivative, joint, several or secondary liability), regardless of whether such debt, obligation, duty or liability would be required to be disclosed on a balance sheet prepared in accordance with generally accepted accounting principles and regardless of whether such debt, obligation, duty or liability is immediately due and payable. To be &quot;Liable&quot; means to have, suffer, incur, be obligated for or be subject to a Liability.</p>
<p>(p) **&quot;Lien&quot;** means any lien, pledge, hypothecation, charge, mortgage, security interest, encumbrance, other possessory interest, conditional sale or other title retention agreement, intangible property right, claim, infringement, option, right of first refusal, preemptive right, exclusive license of intellectual property, community property interest or restriction of any nature including any restriction on the voting of any security or restriction on the transfer, use or ownership of any security or other asset.</p>
<p>(q) **&quot;Material Adverse Exception Event&quot;** means that one or more of the following has occurred, is occurring or would reasonably be expected to occur:</p>
<ul>
<li><p>(i) a Consensus Attack adversely affecting the results or operations of the Designated Smart Contract;</p>
</li>
<li><p>(ii) the Designated Smart Contract having become inoperable, inaccessible or unusable, including as the result of any code library or repository incorporated by reference into the Designated Smart Contract or any other smart contract or oracle on which the Designated Smart Contract depends having become inoperable, inaccessible or unusable or having itself suffered a Material Adverse Exception Event, mutatis mutandis;</p>
</li>
<li><p>(iii) a material and adverse effect on the use, functionality or performance of the Designated Smart Contract as the result of any bug, defect or error in the Designated Smart Contract or the triggering, use or exploitation (whether intentional or unintentional) thereof (it being understood that for purposes of this clause &quot;(iii)&quot;, a bug, defect or error will be deemed material only if it results in a loss to a RealDAO Member or RealDAO of at least 25 percent of such RealDAO Member&#39;s distributable interest in RealDAO Property and/or 15 percent of the RealDAO Property);</p>
</li>
<li><p>(iv) any unauthorized use of an administrative function or privilege of the Designated Smart Contract, including: (A) any use of any administrative credential, key, password, account or address by a Person who has misappropriated or gained unauthorized access to such administrative credential, key, password, account or address or (B) any unauthorized use of an administrative function or privilege by a Holder or a representative of a Holder; or</p>
</li>
<li><p>(v) the Designated Smart Contract, any of Holder or the Owner is subject to a Legal Order that prohibits the Designated Smart Contract (or that, if the Designated Smart Contract were a Person, would prohibit the Designated Smart Contract) from executing any function or operation it would otherwise reasonably be expected to execute.</p>
</li>
<li><p>(vi) the Severed Property Token, has been irretrievable lost, stolen, converted by an unauthorized party or transferred to a party that has not been made a Party to this Agreement.</p>
</li>
<li><p>(r )&quot;Person&quot; means any human, robot, bot, artificial intelligence, corporation, partnership, association or other individual or entity recognized as having the status of a person under the law.</p>
</li>
...
<li><p>(t ) &quot;Transfer&quot; of a Token to a given address (the &quot;Receiving Address&quot;) on the Designated Blockchain Network will be deemed to have occurred if and only if it is recognized by the Designated Client on the Designated Blockchain Network that:</p>
</li>
<li><p>(i) there has been duly transmitted to the Designated Blockchain Network a new transfer function transaction that:(a) provides for the reassociation of the Designated Token with the Receiving Address; and (b) is signed by a private key that is (or a group of private keys that together are) sufficient to authorize the execution of such transfer function; and</p>
</li>
<li><p>(ii) such transaction has been Confirmed.</p>
</li>
</ul>
<p>(u ) **&quot;Guild Kick&quot;** means removal from the membership via vote of RealDAO members to destroy the RealDAO Membership token through a burn function or other process as described in the Handbook. Unless specifically provided otherwise a member subject to a Guild Kick shall not be entitled to any distribution or return of capital, funds, retains, etc nor shall retain any benefit of the Token.</p>
<p>(v ) **&quot;Token Burn&quot;** means destruction or permanent removal from the Token through institution a &quot;burn&quot; function or otherwise sending to Account Address <strong>0x000000000000000000000000000000000000dEaD</strong>.</p>
<p>(w ) **A Cryptographic Hash Function** is a mathematical algorithm that maps data of arbitrary size (often called the &quot;message&quot;) to a bit array of a fixed size (the &quot;hash value&quot;, &quot;hash&quot;, or &quot;message digest&quot;)</p>
